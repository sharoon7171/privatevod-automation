...
// Default settings for auto-favorite video
const autoFavoriteVideoSettings = {
  autoplay: false,
  timer: 0,
  enabled: true,
...
async function getSettings() {
  try {
    ...
    return { ...autoFavoriteVideoSettings, ...result.privatevod_settings };
  } catch (error) {
    console.error('Error getting settings:', error);
    return autoFavoriteVideoSettings;
  }
}
